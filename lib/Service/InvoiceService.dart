...
class InvoiceService {
  ...
  Future<InvoiceResponse> insertInvoice(
      InvoiceRequest invoiceRequest, String token) async {
    final response =
        await http.post(Uri.https(Strings.pathAPI, Strings.apiInvoiceInsert),
            headers: <String, String>{
              Strings.apiContentType: Strings.apiApplicationJson,
              Strings.apiAuthorization: '${Strings.apiBearer} $token',
            },
  ...
  Future<InvoiceResponse> updateInvoice(
    ...
    final response = await http.put(
        Uri.https(Strings.pathAPI,
            '${Strings.apiInvoiceUpdate}/${invoiceRequest.Id}'),
        headers: <String, String>{
          Strings.apiContentType: Strings.apiApplicationJson,
          Strings.apiAuthorization: '${Strings.apiBearer} $token',
        },
  ...
  Future<InvoiceResponse> deleteInvoice(int id, String token) async {
    final response = await http.delete(
        Uri.https(Strings.pathAPI, '${Strings.apiInvoiceDelete}/$id'),
        headers: <String, String>{
          Strings.apiContentType: Strings.apiApplicationJson,
          Strings.apiAuthorization: '${Strings.apiBearer} $token',
        });
  ...
  Future<InvoiceResponseList> getInvoiceBySearch(
      String token, String search) async {
    final response = await http.get(
      Uri.https(Strings.pathAPI, '${Strings.apiInvoiceGetSearch}/$search'),
      headers: <String, String>{
        Strings.apiContentType: Strings.apiApplicationJson,
        Strings.apiAuthorization: '${Strings.apiBearer} $token',
      },
  ...
  Future<InvoiceResponseList> postInvoiceBySearch(
      InvoiceSearchRequest invoiceSearchRequest, String token) async {
    final response = await http.post(
        Uri.https(Strings.pathAPI, Strings.apiInvoicePostSearch),
        headers: <String, String>{
          Strings.apiContentType: Strings.apiApplicationJson,
          Strings.apiAuthorization: '${Strings.apiBearer} $token',
        },
