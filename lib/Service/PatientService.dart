...
class PatientService {
  Future<PatientResponseList> getPatients(
    String token,
  ) async {
  ...
  Future<PatientResponseList> getPatientsByCategory(
  ...
  Future<PatientResponse> getPatientById(int id, String token) async {
    final response = await http.get(
      Uri.https(Strings.pathAPI, '${Strings.apiPatientGetId}/$id'),
      headers: <String, String>{
        Strings.apiContentType: Strings.apiApplicationJson,
        Strings.apiAuthorization: '${Strings.apiBearer} $token',
      },
  ...
  Future<PatientResponse> insertPatient(
    ...
    final response =
        await http.post(Uri.https(Strings.pathAPI, Strings.apiPatientInsert),
            headers: <String, String>{
              Strings.apiContentType: Strings.apiApplicationJson,
              Strings.apiAuthorization: '${Strings.apiBearer} $token',
            },
  ...
  Future<PatientResponse> updatePatient(
    ...
    final response = await http.put(
        Uri.https(Strings.pathAPI,
            '${Strings.apiPatientUpdate}/${patientRequest.Id}'),
        headers: <String, String>{
          Strings.apiContentType: Strings.apiApplicationJson,
          Strings.apiAuthorization: '${Strings.apiBearer} $token',
        },
  ...
  Future<PatientResponse> deletePatient(int id, String token) async {
    final response = await http.delete(
        Uri.https(Strings.pathAPI, '${Strings.apiPatientDelete}/$id'),
        headers: <String, String>{
          Strings.apiContentType: Strings.apiApplicationJson,
          Strings.apiAuthorization: '${Strings.apiBearer} $token',
        });
  ...
  Future<PatientResponseList> getPatientBySearch(
